...
class Gradebook(ttk.Frame):
    def __init__(self, master_window):
        ...
        instruction_text = "Por favor introduce la informacion de la maquina: " 
    ...
    def create_buttonbox(self):
        ...
        # Log Out Button
        log_out_btn = ttk.Button(
            master=button_container,
            text="Cerrar sesion",
            command=self.on_logout,  # This method will handle the logout process
            bootstyle=WARNING,
            width=8,
        )   
...
def start_forms():
    app = ttk.Window("Forms", "superhero", resizable=(False, False))
    Gradebook(app)
    app.mainloop()
